...
import publicAppointmentsRoutes from './routes/publicAppointments';
import clinicasRoutes from './routes/clinicas';
import clinicaSettingsRoutes from './routes/clinicaSettings';
import clinicaCompanyRoutes from './routes/clinicaCompany';
...
app.use('/api/open-slots', openSlotsRoutes);
...
app.use('/api/public/appointments', publicAppointmentsRoutes);
app.use('/api/clinicas', clinicasRoutes);
app.use('/api/clinica/role-permissions', clinicaSettingsRoutes);
app.use('/api/clinica/company', clinicaCompanyRoutes);
